...
const ProductEditScreen = {
  ...
  render: async () => {
    ...
    <div class="content">
      <div>
        <a href="/#/productlist">Trở Về Trang Chủ</a>
      </div>
        ...
        <form id="edit-product-form">
          <ul class="form-items">
            ...
            <li>
              ...
              <input type="integer" name="price" value="${
                product.price
              }" id="price" />
            </li>
            <li>
              <label for="image">Hình ảnh (680 x 830)</label>
            ...
            <li>
              <label for="countInStock">Số Lượng Nhập</label>
            ...
            <li>
              <label for="description">Miểu Tả</label>
